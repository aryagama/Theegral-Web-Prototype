...
const visibilitySettings = {
  colorMode: localStorage.getItem("work1ColorMode") === "bw",
  fontLarge: localStorage.getItem("work1FontSize") === "large",
...
toggleColorMode.addEventListener("click", () => {
  ...
  localStorage.setItem("work1ColorMode", visibilitySettings.colorMode ? "bw" : "normal");
  renderVisibilityStates();
});

toggleFontSize.addEventListener("click", () => {
  visibilitySettings.fontLarge = !visibilitySettings.fontLarge;
  localStorage.setItem("work1FontSize", visibilitySettings.fontLarge ? "large" : "normal");
  renderVisibilityStates();
});
